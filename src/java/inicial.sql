...
INSERT INTO ruta (nombre, descripcion, distancia, tiempo, dificultad, tiporuta, nombreFoto, publica, likes, listadeids, usuarioid) VALUES ('Carretera de Sotiel', 'Paseo tranquilo junto al río, ideal para principiantes y disfrutar del paisaje', 47.2, 40, 'Fácil', 'Carretera', 'sotiel.jpg', 1, 0, ',', 2);
